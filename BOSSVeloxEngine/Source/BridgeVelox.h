...
using ExpressionSpanArgument = boss::expressions::ExpressionSpanArgument;
  ...
  enum BossType { bINTEGER = 0, bCHAR, bBIGINT, bREAL, bDOUBLE, bSHORT };
...
struct BossArray {
  ...
  VectorPtr importFromBossAsOwner(BossType bossType, BossArray&& bossArray, memory::MemoryPool* pool, BufferPtr indices = nullptr);
